...
export function MainContent() {
  const {
    Concept: { CrossBrowserCompatibility },
  } = primer
  ...
  return (
    <main className="flex-row flex-lg-column main-content mt-4 mt-lg-6 pb-6 mx-auto px-3">
      <div className="clearfix">
        ...
        <CrossBrowserCompatibility.SpecificationsStandardsGuidelines className="markdown-body pb-3" />
        <CrossBrowserCompatibility.OpenSourceDependencyProjects className="markdown-body pb-3" />
        <CrossBrowserCompatibility.Implementation.ProductMicrosites className="markdown-body pb-3" />
      </div>
    </main>
  )
}
