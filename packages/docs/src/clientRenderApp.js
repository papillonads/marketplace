...
import { homePageRoute, conceptPageRoute, corePageRoute, notFoundPageRoute } from './route'
    ...
    <ErrorBoundary>
      <BrowserRouter>
        <Switch>
          ...
          />
          <Route exact={corePageRoute.core.exact} path={corePageRoute.core.path} component={corePageRoute.core.clientComponent} />
